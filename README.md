...
- [Usage](#usage)
  ...
  - [Install](#install)
  - [Full advantage of `clangd`](#full-advantage-of-clangd)
- [Features](#features)
...
### Full advantage of `clangd`

In order to see all references within the project it is strongly recommended to run
...
This will create an `external` directory with all external dependencies fetched.
They will then be available from the `compile_commands.json`.
